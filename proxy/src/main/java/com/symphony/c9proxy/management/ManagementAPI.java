...
public class ManagementAPI {
    ...
    public ManagementAPI(C9Config config, RestTemplateBuilder restTemplateBuilder)
    ...
    public void handleException(HttpServletResponse response, HttpClientErrorException e) throws IOException {
    ...
    public String getUsers() {
        api.postForObject("/users", Map.of("userNames", List.of("johanblumenberg")), UsersResponse.class);
        return "Yes!";
    }
}
