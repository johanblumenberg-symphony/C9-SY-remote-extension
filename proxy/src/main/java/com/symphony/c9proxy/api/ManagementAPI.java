...
public class ManagementAPI {
    ...
    @GetMapping("/user")
    public Object getUser(@RequestHeader("x-symphony-csrf-token") String csrfToken,
    ...
    @GetMapping("/buttons")
    public Object getButtons(@RequestHeader("x-symphony-csrf-token") String csrfToken,
        @RequestHeader("cookie") List<String> cookies) {
        SBEUser sbeUser = sbeApi.getUser(csrfToken, cookies);
